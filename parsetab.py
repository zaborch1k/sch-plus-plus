...
_lr_productions = [
  ...
  ('program -> program statement','program',2,'p_program','lexparse.py',179),
  ('program -> statement','program',1,'p_program','lexparse.py',180),
  ('program -> <empty>','program',0,'p_program','lexparse.py',181),
  ('block -> NEWLINE INDENT groupstat DEDENT','block',4,'p_block','lexparse.py',193),
  ('groupstat -> groupstat statement','groupstat',2,'p_groupstat','lexparse.py',197),
  ('groupstat -> <empty>','groupstat',0,'p_groupstat','lexparse.py',198),
  ('statement -> command NEWLINE','statement',2,'p_statement','lexparse.py',209),
  ('command -> IFBLOCK RIGHT block ENDIF','command',4,'p_command_ifblock','lexparse.py',214),
  ('command -> IFBLOCK DOWN block ENDIF','command',4,'p_command_ifblock','lexparse.py',215),
  ('command -> IFBLOCK UP block ENDIF','command',4,'p_command_ifblock','lexparse.py',216),
  ('command -> IFBLOCK LEFT block ENDIF','command',4,'p_command_ifblock','lexparse.py',217),
  ('command -> IFBLOCK error block ENDIF','command',4,'p_command_ifblock_error','lexparse.py',227),
  ('command -> IFBLOCK error groupstat ENDIF','command',4,'p_command_ifblock_error','lexparse.py',228),
  ('command -> IFBLOCK RIGHT error groupstat ENDIF','command',5,'p_command_ifblock_error1','lexparse.py',236),
  ('command -> IFBLOCK DOWN error groupstat ENDIF','command',5,'p_command_ifblock_error1','lexparse.py',237),
  ('command -> IFBLOCK UP error groupstat ENDIF','command',5,'p_command_ifblock_error1','lexparse.py',238),
  ('command -> IFBLOCK LEFT error','command',3,'p_command_ifblock_error1','lexparse.py',239),
  ('command -> REPEAT expr block ENDREPEAT','command',4,'p_command_repeat','lexparse.py',250),
  ('command -> REPEAT error block ENDREPEAT','command',4,'p_command_repeat_error','lexparse.py',260),
  ('command -> REPEAT error groupstat ENDREPEAT','command',4,'p_command_repeat_error','lexparse.py',261),
  ('command -> REPEAT expr error groupstat ENDREPEAT','command',5,'p_command_repeat_error1','lexparse.py',269),
  ('command -> PROCEDURE ID block ENDPROC','command',4,'p_command_procedure','lexparse.py',280),
  ('command -> PROCEDURE error block ENDPROC','command',4,'p_command_procedure_error','lexparse.py',290),
  ('command -> PROCEDURE error groupstat ENDPROC','command',4,'p_command_procedure_error','lexparse.py',291),
  ('command -> PROCEDURE ID error groupstat ENDPROC','command',5,'p_command_procedure_error1','lexparse.py',299),
  ('command -> CALL ID','command',2,'p_command_call','lexparse.py',310),
  ('command -> CALL error','command',2,'p_command_call_error','lexparse.py',314),
  ('command -> RIGHT expr','command',2,'p_command_dir','lexparse.py',323),
  ('command -> LEFT expr','command',2,'p_command_dir','lexparse.py',324),
  ('command -> UP expr','command',2,'p_command_dir','lexparse.py',325),
  ('command -> DOWN expr','command',2,'p_command_dir','lexparse.py',326),
  ('command -> RIGHT error','command',2,'p_command_dir_error','lexparse.py',330),
  ('command -> LEFT error','command',2,'p_command_dir_error','lexparse.py',331),
  ('command -> UP error','command',2,'p_command_dir_error','lexparse.py',332),
  ('command -> DOWN error','command',2,'p_command_dir_error','lexparse.py',333),
  ('command -> SET ID EQUALS expr','command',4,'p_command_set','lexparse.py',344),
  ('command -> SET error','command',2,'p_command_set_error','lexparse.py',349),
  ('command -> SET ID error','command',3,'p_command_set_error2','lexparse.py',357),
  ('command -> SET ID EQUALS error','command',4,'p_command_set_error3','lexparse.py',362),
  ('expr -> expr PLUS factor','expr',3,'p_expr','lexparse.py',371),
  ('expr -> expr MINUS factor','expr',3,'p_expr','lexparse.py',372),
  ('expr -> factor','expr',1,'p_expr','lexparse.py',373),
  ('expr -> MINUS expr','expr',2,'p_expr_uminus','lexparse.py',380),
  ('factor -> factor TIMES fact','factor',3,'p_factor','lexparse.py',384),
  ('factor -> factor DIVIDE fact','factor',3,'p_factor','lexparse.py',385),
  ('factor -> fact','factor',1,'p_factor','lexparse.py',386),
  ('fact -> NUMBER','fact',1,'p_fact_number','lexparse.py',394),
  ('fact -> ID','fact',1,'p_fact_var','lexparse.py',398),
  ('fact -> LPAREN expr RPAREN','fact',3,'p_fact_paren','lexparse.py',402),
]
