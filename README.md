...
Для фунцкциональной схемы можете посмортеть [*документацию*](https://docs.google.com/document/d/1lht9NDHOYLLaUpyFRhH3q0wPC_25eg9rXn4bPLnYMD0/edit). Краткое описание будет тут.
